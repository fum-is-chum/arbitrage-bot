...
// do tx stuff
const coinInId = tx.moveCall({ target: "asdf::asdf::asdf" });

const cointOutId = await afRouterApi.fetchAddTransactionForCompleteTradeRoute({
	tx,
	completeRoute,
	walletAddress: "0x...",
	slippage: 0.01, // 1 %
