...
async function main() {
    ...
    console.log(`You are executing with address: ${scallop.suiKit.currentAddress()}`) //0xa6e5e59eef4645c3ee8b48bcc2feaef543790e18bdabb15e3f765482d211305e
    ...
    const route = await router.getCompleteTradeRouteGivenAmountIn({
        ...
        coinInAmount: 100_000n,
    });

    console.log(route);

    const tx1 = await router.getTransactionForCompleteTradeRoute({
    ...
    const swapResult1 = await scallopBuilder.signAndSendTxBlock(tx1);
